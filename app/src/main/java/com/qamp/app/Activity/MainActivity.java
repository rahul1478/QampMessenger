...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView closeButton = drawer.findViewById(R.id.btn_close_filter);
        ...
        TextView name = drawer.findViewById(R.id.name_text);
        ShapeableImageView imageView = drawer.findViewById(R.id.image);
        if (profile.getImage().getThumbnail() != null){
            imageView.setImageBitmap(profile.getImage().getThumbnail());
        }else {
        ...
        Log.e("deviceToken", AppConfig.getConfig().deviceToken);
        Log.e("Account UUID", String.valueOf(AppConfig.getConfig().phone));

        ArrayList profiles = Mesibo.getSortedUserProfiles();

        Log.e("sorted profilessssss", String.valueOf(profiles.size()));
    ...
    private void initComponent() {
        ...
        final UserListFragment chatFragment = new UserListFragment();
