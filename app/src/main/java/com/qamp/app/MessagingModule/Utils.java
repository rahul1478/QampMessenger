...
//                toolbar.setBackgroundColor(TOOLBAR_COLOR);
    ...
    public static void showAlert(Context context, String title, String message, DialogInterface.OnClickListener onclick) {
        if (context != null) {
            AlertDialog.Builder dialog = new AlertDialog.Builder(context, com.mesibo.messaging.R.style.AlertDialogStyle);
    ...
    public static void showAlert(Context context, String title, String message) {
        AlertDialog.Builder builder = new AlertDialog.Builder(context, com.mesibo.messaging.R.style.AlertDialogStyle);
