...
public class MesiboMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mesibo.messaging.R.layout.activity_maps_address);
        this.mCurrentTextView = (TextView) findViewById(com.mesibo.messaging.R.id.sendCurrent);
        MesiboUI.Config conf = MesiboUI.getConfig();
        this.mCurrentTextView.setText(conf.sendCurrentLocation);
        ((TextView) findViewById(com.mesibo.messaging.R.id.sendselected)).setText(conf.sendAnotherLocation);
        ...
        this.mapFragment = (MapFragment) getFragmentManager().findFragmentById(com.mesibo.messaging.R.id.map);
    ...
    private void setupAutoCompleteFragment() {
        this.mAutocompleteFragment = (AutocompleteSupportFragment) getSupportFragmentManager().findFragmentById(com.mesibo.messaging.R.id.place_autocomplete_fragment);
                ...
                this.fusedLocationClient.getCurrentLocation(102, (CancellationToken) null).addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    public void onSuccess(Location location) {
                        try {
                            ...
                            Toast.makeText(MesiboMapActivity.this, "Give Location Permission", Toast.LENGTH_SHORT).show();
                        }
