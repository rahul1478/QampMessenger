...
public class UserData {
    ...
    public Bitmap getThumbnail(LetterTitleProvider tileProvider, Context context) {
        Bitmap tn = this.mUser.getImage().getThumbnail();
        if (tn != null) {
            return tn;
        }
    ...
    public String getImagePath() {
        return this.mUser.getImage().getImageOrThumbnailPath();
    }
    ...
    public String getTime() {
        return null != this.msg ? this.msg.getTimestamp().getTime(false) : "";
    }
