...
public class ThumbnailProgressView extends FrameLayout {
    ...
    public void init() {
        ...
        this.mFrameLayout = (FrameLayout) this.mInflater.inflate(com.mesibo.messaging.R.layout.thumbnail_progress_view, this, true);
        this.mPictureView = (ImageView) this.mFrameLayout.findViewById(R.id.imageView);
        this.mProgressBar = (ProgressBar) this.mFrameLayout.findViewById(com.mesibo.messaging.R.id.progressBar);
        ...
        MyTrace.stop();
        this.mTransferButton = (Button) this.mFrameLayout.findViewById(com.mesibo.messaging.R.id.transferButton);
        setState(0);
    }
