...
public class MesiboUI {
    ...
    public static class Config {
        public static final int e2eeIcon = com.mesibo.messaging.R.drawable.ic_lock_black_18dp;
    ...
    public static void launchContacts(Context context, long forwardid, int selectionMode, int flag, Bundle bundle, String forwardMessage,Long GroupId) {
