...
public class MesiboEndToEndEncryptionFragment extends BaseFragment implements View.OnClickListener, MessagingActivityListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.mView = inflater.inflate(com.mesibo.messaging.R.layout.fragment_e2e_info, container, false);
        if (this.mView == null) {
            return this.mView;
        }
        if (this.profile.isSelfProfile()) {
            this.mView.findViewById(com.mesibo.messaging.R.id.e2einfo).setVisibility(8);
            this.mView.findViewById(com.mesibo.messaging.R.id.e2eself).setVisibility(0);
            this.mView.findViewById(com.mesibo.messaging.R.id.e2eselfexportbutton).setOnClickListener(this);
            this.mView.findViewById(com.mesibo.messaging.R.id.e2eselfloadbutton).setOnClickListener(this);
            return this.mView;
        }
        this.mView.findViewById(com.mesibo.messaging.R.id.e2eopt).setVisibility(8);
        if (!this.profile.e2ee().isActive()) {
            replaceFirstName(com.mesibo.messaging.R.id.e2einactivetext);
            this.mView.findViewById(com.mesibo.messaging.R.id.e2einfo).setVisibility(8);
            this.mView.findViewById(com.mesibo.messaging.R.id.e2einactive).setVisibility(0);
            return this.mView;
        }
        replaceFirstName(com.mesibo.messaging.R.id.e2etexttop);
        replaceFirstName(com.mesibo.messaging.R.id.e2etextbottom);
        replaceFirstName(com.mesibo.messaging.R.id.e2etextlast);
        replaceFirstName(com.mesibo.messaging.R.id.e2etextlast);
        replaceFirstName(com.mesibo.messaging.R.id.e2eopttext);
        replaceFirstName(com.mesibo.messaging.R.id.e2epasstext);
        replaceFirstName(com.mesibo.messaging.R.id.e2ecerttext);
        this.mView.findViewById(com.mesibo.messaging.R.id.e2eoptbutton).setOnClickListener(this);
        this.mView.findViewById(com.mesibo.messaging.R.id.e2epassbutton).setOnClickListener(this);
        this.mView.findViewById(com.mesibo.messaging.R.id.e2eresetbutton).setOnClickListener(this);
        this.mView.findViewById(com.mesibo.messaging.R.id.e2ecertbutton).setOnClickListener(this);
        ...
        ((TextView) this.mView.findViewById(com.mesibo.messaging.R.id.e2e_fp_top)).setText(fp_top);
        ((TextView) this.mView.findViewById(com.mesibo.messaging.R.id.e2e_fp_bottom)).setText(fp_bottom);
        return this.mView;
    }

    public void onClick(View v) {
        int id = v.getId();
        if (id == com.mesibo.messaging.R.id.e2eoptbutton) {
            this.mView.findViewById(com.mesibo.messaging.R.id.e2einfo).setVisibility(8);
            this.mView.findViewById(com.mesibo.messaging.R.id.e2eopt).setVisibility(0);
            this.mOptions = true;
        } else if (id == com.mesibo.messaging.R.id.e2epassbutton) {
            setPassword();
        } else if (id == com.mesibo.messaging.R.id.e2eresetbutton) {
            reset();
        } else if (id == com.mesibo.messaging.R.id.e2ecertbutton) {
            this.mLocalPrivate = false;
            MediaPicker.launchPicker(getActivity(), MediaPicker.TYPE_FILE);
        } else if (id == com.mesibo.messaging.R.id.e2eselfexportbutton) {
            exportCertificate(getActivity());
        } else if (id == com.mesibo.messaging.R.id.e2eselfloadbutton) {
    ...
    private void setPassword() {
        final TextView t = (TextView) this.mView.findViewById(com.mesibo.messaging.R.id.e2epasstext);
    ...
    public boolean Mesibo_onBackPressed() {
        ...
        this.mView.findViewById(com.mesibo.messaging.R.id.e2einfo).setVisibility(0);
        this.mView.findViewById(com.mesibo.messaging.R.id.e2eopt).setVisibility(8);
        this.mOptions = false;
        return true;
    }
