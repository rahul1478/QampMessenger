...
public class MesiboConfiguration {
    ...
    public static final int STATUS_TIMER = com.mesibo.messaging.R.drawable.ic_av_timer_black_18dp;
    public static final int STATUS_SEND = com.mesibo.messaging.R.drawable.ic_done_black_18dp;
    public static final int STATUS_NOTIFIED = com.mesibo.messaging.R.drawable.ic_check_double_black_18dp;
    public static final int STATUS_READ = com.mesibo.messaging.R.drawable.ic_check_double_black_18dp;
    public static final int STATUS_ERROR = com.mesibo.messaging.R.drawable.ic_error_black_18dp;
    public static final int DELETED_DRAWABLE = com.mesibo.messaging.R.drawable.ic_action_cancel_black_18dp;

    public static final int MISSED_VOICECALL_DRAWABLE = com.mesibo.messaging.R.drawable.baseline_call_missed_black_18;
    public static final int MISSED_VIDEOCALL_DRAWABLE = com.mesibo.messaging.R.drawable.baseline_missed_video_call_black_18;
    ...
    //
    public static final int DEFAULT_PROFILE_PICTURE = com.mesibo.calls.api.R.drawable.default_user_image;
    public static final int DEFAULT_GROUP_PICTURE = com.mesibo.messaging.R.drawable.default_group_image;
    ...
    public static final int PROGRESSVIEW_DOWNLOAD_SYMBOL = com.mesibo.messaging.R.drawable.ic_file_download_white_24dp;
    public static final int PROGRESSVIEW_UPLOAD_SYMBOL = com.mesibo.messaging.R.drawable.ic_file_upload_white_24dp;
    ...
    public static final int VIDEO_ICON = R.drawable.ico_video_camera;
...
//    public static final String EMPTY_MESSAGE_LIST = "";
    ...
    public static final int DEFAULT_LOCATION_IMAGE = com.mesibo.messaging.R.drawable.bmap;
