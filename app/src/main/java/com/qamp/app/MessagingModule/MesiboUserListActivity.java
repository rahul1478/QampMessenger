...
public class MesiboUserListActivity extends AppCompatActivity implements MesiboUserListFragment.FragmentListener {
    ...
    /* JADX WARNING: type inference failed for: r14v0, types: [android.content.Context, com.qamp.app.MessagingModule.MesiboUserListActivity, com.qamp.app.MessagingModule.MesiboUserListFragment$FragmentListener, androidx.appcompat.app.AppCompatActivity] */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mesibo.messaging.R.layout.activity_messages);
        this.mMesiboUIOptions = MesiboUI.getConfig();
        Toolbar toolbar = findViewById(com.mesibo.messaging.R.id.message_toolbar);
        this.contactsSubTitle = (TextView) findViewById(com.mesibo.messaging.R.id.contacts_subtitle);
        this.contactsTitle = (TextView) findViewById(com.mesibo.messaging.R.id.contacts_title);
        ...
        if (savedInstanceState == null) {
            ...
            ft.replace(com.mesibo.messaging.R.id.userlist_fragment, userListFragment, "null");
