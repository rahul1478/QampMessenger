...
public class MesiboEndToEndEncryptionActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mesibo.messaging.R.layout.activity_e2e_info);
        ...
        if (args != null) {
            ...
            TextView st = (TextView) findViewById(com.mesibo.messaging.R.id.e2e_subtitle);
            ...
            ft.replace(com.mesibo.messaging.R.id.fragment_place, this.mFragment, "null");
            ft.commit();
        }
    }
