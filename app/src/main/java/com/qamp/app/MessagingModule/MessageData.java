...
public class MessageData {
    ...
    MessageData(Context context, MesiboMessage msg) {
        ...
        if (msg.isDate()) {
            ...
            msg.message = msg.date.getDate(opts.showMonthFirst, opts.today, opts.yesterday,true);
        }
    ...
    public String getTimestamp() {
        MesiboDateTime m = this.msg.getTimestamp();
    ...
    public String getDateStamp() {
        MesiboUiDefaults opts = MesiboUI.getUiDefaults();
        MesiboDateTime d = this.msg.getTimestamp();
        return d.getDate(opts.showMonthFirst, opts.today, opts.yesterday,true);
    }
